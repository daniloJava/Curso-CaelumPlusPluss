...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<h3>Contato <a>${param.nome}</a> adicionado com sucesso</h3>
			<br> <a href="mvc?logica=ListaContatosLogic"><button
					class="btn btn-default">Lista</button></a> <a
				href="adiciona-contato.jsp"><button class="btn btn-default">Voltar</button></a>
		</div>
	</div>
